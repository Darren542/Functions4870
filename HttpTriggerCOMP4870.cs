...
namespace COMP4870.Function;
public class HttpTriggerCOMP4870
{
    private readonly ILogger<HttpTriggerCOMP4870> _logger;

    private readonly SchoolContext _context;

    public HttpTriggerCOMP4870(ILoggerFactory loggerFactory, SchoolContext context)
    {
        _logger = loggerFactory.CreateLogger<HttpTriggerCOMP4870>();
        _context = context;
    }
